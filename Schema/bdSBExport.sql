...
-- Tiempo de generación: 27-01-2020 a las 07:08:58
...
--
-- Estructura de tabla para la tabla `diary_balance`
--
...
--
-- Indices de la tabla `diary_balance`
--
...
--
-- AUTO_INCREMENT de la tabla `diary_balance`
--
ALTER TABLE `diary_balance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `diary_balance`
--
ALTER TABLE `diary_balance`
