...
-- Tiempo de generación: 26-01-2020 a las 03:13:32
...
(3, 'descripcion 1 ejemplo', 2000, 1, '2020-01-24', 1, NULL, NULL, NULL, NULL, '2020-01-24', 1),
(4, 'descripcion 1 ejemplo', 500, 1, '2020-01-25', 1, NULL, NULL, NULL, NULL, '2020-01-25', 1),
(5, 'descripcion 1 ejemplo', 600, 1, '2020-01-25', 1, NULL, NULL, NULL, NULL, '2020-01-25', 1);
...
(1, 'santiago', 'rinaldi', 40865001, 'rinaldisantiago@hotmail.com', '$2y$10$I0CEQj.Ve.G12zcGxATyguV7NFQwGpkxYTDDudo7IeZ4qFZv2.hKy', 1, '2020-01-22', 1, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Estructura de tabla para la tabla `checkc`
--
...
(3, 'juan', 'perez', 'domicilio 123', 'mar del plata', 7600, 'juan@perez.com', 132112233, '3', 1313131, 'cash', 'car', 1, '2020-01-24', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'carlos', 'lopez', 'direcc 312', 'mar del', 7609, 'carlos@lopez.com', 13433113, '3', 0, '13454513', '200', 1, '2020-01-25', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'santiago', 'rinaldi', 'piedrabuena 237', 'mar del plata', 7600, 'sant@mail.com', 2147483647, '3', 40404044, '', 'car', 1, '2020-01-25', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 'nombre1', 'apellido1', 'domi 83', 'mardel', 7677, 'mail@ejmpl.com', 403012, '3', 3931387, '', 'van', 1, '2020-01-25', 1, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Estructura de tabla para la tabla `mobile_parasol`
--
...
--
-- Volcado de datos para la tabla `mobile_parasol`
--
...
(3, '2020-01-24', '2020-01-26', 'january_day', 0, 3500, 3, 192, NULL, 1, '2020-01-24', 1, NULL, NULL, NULL, NULL, '2020-01-24', 1),
(5, '2020-01-28', '2020-02-03', 'enero_dia', 0, 1000, 7, 3, NULL, 1, '2020-01-25', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(6, '2020-02-01', '2020-02-29', 'febrero', 0, 1000, 8, 18, NULL, 1, '2020-01-25', 1, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Volcado de datos para la tabla `reservationxservice`
--
...
--
-- Estructura de tabla para la tabla `servicexmobileparasol`
--
...
--
-- Volcado de datos para la tabla `servicexmobileparasol`
--
...
--
-- Volcado de datos para la tabla `servicexparking`
--
...
--
-- Indices de la tabla `mobile_parasol`
--
...
--
-- Indices de la tabla `servicexmobileparasol`
--
...
--
-- AUTO_INCREMENT de la tabla `checkc`
--
ALTER TABLE `checkc`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `mobile_parasol`
--
ALTER TABLE `mobile_parasol`
...
--
-- Filtros para la tabla `servicexmobileparasol`
--
ALTER TABLE `servicexmobileparasol`
